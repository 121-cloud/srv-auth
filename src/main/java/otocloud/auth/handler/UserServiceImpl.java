...
public class UserServiceImpl implements UserService {
    ...
    *//**
    ...
    @Override
    public void createUser(JsonObject userInfo, Future<User> doneFuture) {
        ...
        try {
            ...
            verifyFuture.setHandler(ret -> {
                ...
                future.setHandler(result -> {
                    if (result.succeeded()) {
                        ...
                        logger.warn("管理员用户创建成功, OpenID：" + u.getOpenID());
            ...
            logger.warn("管理员用户创建失败：" + e.getMessage());
        }

    }

    //@Override
    public void addPost(Long acctId, Long bizUnitId, Long postId, Long userId, Future<User> addFuture) {
    ...
    *//**
     ...
     * @param userId
     *//*
    private void syncAddPost(Long acctId, Long bizUnitId, Long postId, Long userId, Future<UpdateResult> addFuture) {
    ...
    *//**
    ...
    public void login(String userName, String password, boolean useCellNo,
        ...
        JsonObject reply = createReply(loginUser, userOpenId, token);
    ...
    *//**
     ...
     *//*
    //@Override
    public void login2(String userName, String password, boolean useCellNo,
                      String sessionId, Future<JsonObject> future) {
        //通过用户名查找可能匹配的用户列表
        AuthUserExample example = new AuthUserExample();
        AuthUserExample.Criteria c = example.createCriteria().andDeleteDatetimeIsNull();
    ...
    private JsonObject createReply(AuthUser user, String userOpenId, String token) {
    ...
    private void stayOnline(User user, String sessionId, String userOpenId, String token, Future<Void> future) {
        if (null == sessionId) {
    ...
    *//**
	...
	@Override
	public void findAcctForUser(Long userId, Future<JsonArray> future) {
		// TODO Auto-generated method stub
